...
from chess_commentator.perception.undistort import build_undistort_maps, get_lite_camera_KD, undistort
...
def annotate_existing(
    ...
    Usage:
        python -m chess_commentator.perception.calibration data/generated/<setup>/raw.png
    """
