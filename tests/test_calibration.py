...
Importing ``chess_commentator.perception.calibration`` must not require ``reachy_mini`` — the robot import is
...
from chess_commentator.perception.calibration import (
